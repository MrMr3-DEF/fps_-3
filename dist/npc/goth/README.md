...
`temperature` controls variation: a lower value is usually more consistent, a higher value more varied. It cannot fix reasoning errors. `maxReplyTokens` controls the maximum generated length; the default is 96 and supported values are 32–192. She is prompted to use one or two sentences.
